    ...
    <div className="scene" id="hotelinfo">
        ...
        <article id="usefulinfo">
            ...
            <ul>
                ...
                <li><strong>Trains:</strong> The nearest Underground station is at Convey road.</li>
